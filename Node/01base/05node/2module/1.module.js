...
// es6Module “静态”导入, 在编译的时候就可以知道使用了哪些变量, 可以实现tree-shaking 
// commonjs 模块 “动态导入”, commonjs 模块是不支持tree-shaking  (可以读文件是同步操作)
...
// 调试方法：
// 1. 终端输入命令： node  --inspect-brk 1.module.js （这个需要借助浏览器调试，不推荐）
// 2. vscode 调试


// （看源码：先横向扩展，在纵向深入。 避免一个函数看到底）   一直调试代码
